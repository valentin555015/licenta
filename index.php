<html>
    ...
    <head>
        <title>::DIDI:: | Online Shopping</title>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div id="slider">
                <div class="container">
                    <ul class="bxslider">
                        <li><img src="imagini/img1.jpg"></li>
                        <li><img src="imagini/img2.jpg"></li>
                        <li><img src="imagini/img3.jpg"></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <!--Prima categorie-->
                    ...
                    <div class="catbox">
                        <a href="femei.php">
                        <img src="imagini/cat5.jpg" alt="Men-fashion">
                        <span>Femei</span>
                        </a>
                    </div>
                ...
                <!--A doua categorie-->
                  ...
                  <div class="catbox">
                       <a href="barbati.php">
                        <img src="imagini/cat1.jpg" alt="Men-fashion">
                        <span>Barbati</span>
                        </a>
                    </div>
                ...
                <!--A treia categorie-->
                    ...
                    <div class="catbox">
                       <a href="copii.php">
                        <img src="imagini/cat3.jpg" alt="Men-fashion">
                        <span>Copii</span>
                        </a>
                    </div>
                ...
                <!--A patra categorie-->
                    ...
                    <div class="catbox">
                       <a href="incaltaminte.php">
                        <img src="imagini/cat2.jpg" alt="Men-fashion">
                ...
                <!--A cincea categorie-->
                    ...
                    <div class="catbox">
                       <a href="accesorii.php">
                        <img src="imagini/cat4.jpg" alt="Men-fashion">
                        <span>Accesorii</span>
                        </a>
                    </div>
                ...
                <div class="prod-container">
                    ...
                    <!--primul produs-->
                    <div class="prod-box">
                        <img src="imagini/pro1.jpg" alt="man suit">
                    ...
                    <!--al doilea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro2.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>Man T-shirt</p>
                    ...
                    <!--al treilea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro3.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>Ladies sandal</p>
                    ...
                    <!--al patrulea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro4.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>Ladies sandal 2</p>
                    ...
                    <!--al cincilea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro5.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>Ladies hand bag</p>
                    ...
                    <!--al saselea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro6.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>white hand bag</p>
                    ...
                    <!--al saptelea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro7.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>neckless</p>
                    ...
                    <!--al optulea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro8.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>blue pendent</p>
                    ...
                    <!--al noualea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro9.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                    ...
                    <!--al zecelea produs-->
                    <div class="prod-box">
                        <img src="imagini/pro10.jpg" alt="man suit">
                        <div class="prod-trans">
                            <div class="prod-feature">
                                <p>Ladies jacket</p>
                ...
                <div class="container">
                    ...
                    <!--casute cu oferte-->
                    <div class="offer">
                        <a href="#"><img src="imagini/offer1.JPG"></a>
                    </div>
                    <div class="offer">
                        <a href="#"><img src="imagini/offer2.JPG"></a>
                    </div>
                    <div class="offer">
                        <a href="#"><img src="imagini/offer3.JPG"></a>
                    </div>
                </div>
            </div>
